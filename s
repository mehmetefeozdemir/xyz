  ...
  <slide class="title-slide segue nobackground">
    ...
    <hgroup class="auto-fadein">
      ...
      <p data-config-presenter><!-- populated from slide_config.json --></p>
            <p style="margin-top: 6px; margin-left: -2px;">10/07/2020</p>
          </hgroup>
  </slide>

<slide class=""><hgroup><h2>Introduction</h2></hgroup><article  id="introduction">

<p>The goal of this exercise is to create a product to highlight the prediction algorithm that you have built and to provide an interface that can be accessed by others. For this project you must submit:<br></p>

<p>A Shiny app that takes as input a phrase (multiple words) in a text box input and outputs a prediction of the next word.<br> A slide deck consisting of no more than 5 slides created with R Studio Presenter (<a href='https://support.rstudio.com/hc/en-us/articles/200486468-Authoring-R-Presentations' title=''>https://support.rstudio.com/hc/en-us/articles/200486468-Authoring-R-Presentations</a>) pitching your algorithm and app as if you were presenting to your boss or an investor.<br></p>

</article></slide><slide class=""><hgroup><h2>Algorithm used to make prediction</h2></hgroup><article  id="algorithm-used-to-make-prediction">

<pre class = 'prettyprint lang-r'>predictWord &lt;- function(the_word) {
...
</article></slide><slide class=""><hgroup><h2>Functioning of the App</h2></hgroup><article  id="functioning-of-the-app">

<ol>
<li>The first task is to load the libraries.</li>
<li>Next we load the bigram, trigram and quadgram frequencies words matrix frequencies</li>
<li>Next we use the function to predict the word.</li>
<li>Then we use the function predictWord</li>
</ol>

</article></slide><slide class=""><hgroup><h2>Experience using the app</h2></hgroup><article  id="experience-using-the-app">

<ol>
<li>The app uses the correct prediction algorithm for words prediction</li>
<li>The results shown uses the functions for prediction.</li>
</ol>

<p>##The link for GITHUB and RPub</p>

<p>Below are the link for github</p>

<p><a href='https://github.com/abhijeetkmohite/Peer-graded-Assignment-Final-Project-Submission' title=''>https://github.com/abhijeetkmohite/Peer-graded-Assignment-Final-Project-Submission</a></p>

<p>Below is the link for Rpub</p>

<p><a href='https://rpubs.com/abhijeetkmohite/data_science_capstone' title=''>https://rpubs.com/abhijeetkmohite/data_science_capstone</a></p>

</article></slide><slide class=""><hgroup><h2>Thank You</h2></hgroup><article  id="thank-you">

<p>Thank you all for viewing my presentation</p></article></slide>
